% load gtIndsSeq5KT.mat
if affinityOn
    results = resultsA;
end

load('\\visionnas2.cs.ucf.edu\share\graduate_students\Salman_Khokhar\Old_projects\Soccer\code_from_khurram\Code\Code_Salman\MatlabCodes\assocGT\Vid1Seq7_Team1GTTrackAssoc');
